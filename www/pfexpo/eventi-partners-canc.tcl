...
pf::user_must_admin
with_catch errmsg {
    db_dml query "delete from expo_eve_par where evento_id = :evento_id and partner_id = :partner_id"
} {
...
ad_returnredirect [export_vars -base "eventi-partners-list" {evento_id}]
ad_script_abort
