...
ad_form -name evento \
	...
	"SELECT evento_id, denominazione, descrizione, permalink, sala_id, start_time, end_time, prezzo::decimal, percorso_id, soldout FROM expo_eventi WHERE evento_id = :evento_id"
    } -new_data {
	...
	db_dml query "INSERT INTO expo_eventi (evento_id, denominazione, permalink, descrizione, sala_id, start_time, end_time, prezzo, expo_id, percorso_id, soldout) VALUES (:evento_id, :denominazione, :permalink, :descrizione, :sala_id, $start_time, $end_time, :prezzo::money, :expo_id, :percorso_id, :soldout)"
    } -edit_data {
	db_dml query "UPDATE expo_eventi SET denominazione = :denominazione, descrizione = :descrizione, sala_id = :sala_id, start_time = $start_time, end_time = $end_time, prezzo = :prezzo::money, permalink = :permalink, soldout = :soldout WHERE evento_id = :evento_id"
    } -after_submit {
