...
set header "Codice Iscritto;Nome;Cognome;Email;Società;Data iscrizione;Portafoglio;Clienti;Attività"
...
puts $f $header
db_foreach query "select iscritto_id, nome, cognome, email, societa, to_char(data, 'DD/MM/YYYY')as data, portafoglio, clienti, attivita from expo_iscritti where expo_id = :expo_id" {
    set row "$iscritto_id;$nome;$cognome;$email;$societa;$data;$portafoglio;$clienti;$attivita"
